...
tiff("HSFko upregulate Enrichment KEGG.tif",res = 600, compression = "lzw", width=6, height=10, units="in")
barplot(KEGG_up ,title="Enrichment KEGG _up")
dev.off()

head(kk,2)
EKEGG_up <- setReadable(KEGG_up , 'org.Mm.eg.db', 'ENTREZID')
write.csv(EKEGG_up@result, file = "KEGG_up.csv")
